...
if(op==1):
 os.system("clear")
 os.system("cd && cd All-Tools && bash Help/FilesAndBaseCommads.sh")
 os.system("cd && cd All-Tools && python3 src/Timer1.py && python2 src/aboutMenu.py")
elif(op==2):
 os.system("clear")
 os.system("cd && cd All-Tools && bash Help/ProcessControlerCommands.sh")
 os.system("cd && cd All-Tools && python3 src/Timer1.py && python2 src/aboutMenu.py")
elif(op==6):
 os.system("clear")
 os.system("cd && cd All-Tools && bash Help/SearchCommand.sh")
 os.system("cd && cd All-Tools && python3 src/Timer1.py && python2 src/aboutMenu.py")
elif(op==3):
 os.system("clear")
 os.system("cd && cd All-Tools && bash Help/AccesRightAndFilesCommands.sh")
 os.system("cd && cd All-Tools && python3 src/Timer1.py && python2 src/aboutMenu.py")
elif(op==4):
 os.system("clear")
 os.system("cd && cd All-Tools && bash Help/SystemInformationCommands.sh")
 os.system("cd && cd All-Tools && python3 src/Timer1.py && python2 src/aboutMenu.py")
elif(op==5):
 os.system("clear")
 os.system("cd && cd All-Tools && bash Help/InstallingPackagesAndWorkingCommands.sh")
 os.system("cd && cd All-Tools && python3 src/Timer1.py && python2 src/aboutMenu.py")
elif(op==7):
 os.system("clear")
 os.system("cd && cd All-Tools && bash Help/ArchiveFilesCommands.sh")
 os.system("cd && cd All-Tools && python3 src/Timer1.py && python2 src/aboutMenu.py")
elif(op==8):
 os.system("clear")
 os.system("cd && cd All-Tools && bash Help/NetworkComands.sh")
 os.system("cd && cd All-Tools && python3 src/Timer1.py && python2 src/aboutMenu.py")
elif(op==9):
 time.sleep(0.2)

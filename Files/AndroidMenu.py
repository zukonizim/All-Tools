...
print("  \033[1;34m[ 05 ] >> \033[1;36;40mExit System - Log out All-Tools")
...
if(op==1):
 os.system("clear")
 os.system("cd && cd All-Tools && cd pyshell && ./Pyshell && cd && cd All-Tools && python2 MainMenu.py")
elif(op==2):
 os.system("clear")
 os.system("cd && cd All-Tools && cd WishFish && ./wishfish.sh && cd && cd All-Tools && python2 MainMenu.py")
elif(op==3):
 os.system("clear")
 os.system("cd && cd All-Tools && cd lockphish && bash lockphish.sh && cd && cd All-Tools && python2 MainMenu.py")
elif(op==4):
 os.system("clear")
 os.system("cd && cd All-Tools && cd Files && bash HatCloud.sh && cd && cd All-Tools && python3 src/Timer2.py && python2 MainMenu.py")
elif(op==5):
 time.sleep(0.2)

...
if(op==1):
 os.system("clear")
 os.system("cd && cd All-Tools && cd Facebook-BruteForce && python3 fb.py or python fb2.py")
elif(op==2):
 os.system("clear")
 os.system("cd && cd All-Tools && cd Files && bash SherlockUser.sh")
elif(op==3):
 os.system("clear")
 os.system("cd && cd All-Tools && cd UserFinder && bash UserFinder.sh && cd && cd All-Tools && python3 src/Timer3.py")
elif(op==4):
 time.sleep(0.2)

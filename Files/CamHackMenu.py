...
if(op==1):
 os.system("clear")
 os.system("cd && cd All-Tools && cd Cam-Hackers && python3 cam-hackers.py && cd && cd All-Tools && python2 MainMenu.py")
elif(op==2):
 os.system("clear")
 os.system("cd && cd All-Tools && cd grabcam && bash grabcam.sh && cd && cd All-Tools && python2 MainMenu.py")
elif(op==3):
 os.system("clear")
 os.system("cd && cd All-Tools && cd CamHack && bash CamHack.sh && cd && cd All-Tools && python2 MainMenu.py")
elif(op==4):
 time.sleep(0.2)

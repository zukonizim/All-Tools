...
cd 
clear
python3 All-Tools/.check/ServerStatusCheck.py
cd
cd
bash All-Tools/.check/ServerConfig.sh
clear
cd
cd 
cd && cd All-Tools && python2 src/TerminalBanner.py
cd
cd
cd All-Tools
cd Tool
chmod +x folder
chmod +x os
mv folder /data/data/com.termux/files/home/All-Tools
mv os /data/data/com.termux/files/home/All-Tools
cd
cd
cd All-Tools
cd Files
...
'|lolcat -p 1.0
echo -e $b"[^_^]"$w" All-Tools donate: "$g"https://www.buymeacoffee.com/misakorzik"$w
echo -e $b"[^_^]"$w" SuccesFull Installed: "$g"All-Tools"$w

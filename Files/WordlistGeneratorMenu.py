...
print("  \033[1;34m[ 04 ] >> \033[1;36;40mExit System - log out All-Tools")
...
if(op==1):
 os.system("clear")
 os.system("cd && cd All-Tools && cd wlcreator && ./wlcreator 5 && cd && cd All-Tools && python2 MainMenu.py")
elif(op==2):
 os.system("clear")
 os.system("cd && cd All-Tools && cd GoblinWordGenerator && python3 goblin.py && cd && cd All-Tools && python2 MainMenu.py")
elif(op==3):
 os.system("clear")
 os.system("cd && cd All-Tools && cd SMWYG-Show-Me-What-You-Got && python3 SMWYG.py && cd && cd All-Tools && python2 MainMenu.py")
elif(op==4):
 time.sleep(0.2)

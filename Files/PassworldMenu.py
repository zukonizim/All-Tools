...
if(op==1):
 os.system("clear")
 os.system("cd && cd All-Tools && cd hasher && python2 hash.py && cd && cd All-Tools && python2 MainMenu.py")
elif(op==2):
 os.system("clear")
 os.system("cd && cd All-Tools && cd hasherdoid && python2 hasherdotid.py && cd && cd All-Tools && python2 MainMenu.py")
elif(op==3):
 os.system("clear")
 os.system("cd && cd All-Tools && cd hash-generator && python2 hashgen.py && cd && cd All-Tools && python2 MainMenu.py")
elif(op==4):
 os.system("clear")
 os.system("cd && cd All-Tools && cd Hash-Buster && python3 hash.py && cd && cd All-Tools && python2 MainMenu.py")
elif(op==5):
 time.sleep(0.2)

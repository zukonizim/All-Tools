...
print("  \033[1;34m[ 03 ] >> \033[1;36;40mExit System  -  exit All-Tools")
...
if(op==1):
 os.system("clear")
 os.system("cd && cd All-Tools && bash Files/Proxy/Logo.sh && python2 Files/Proxy/menu.py && cd")
elif(op==2):
 os.system("clear")
 os.system("cd && cd All-Tools && cd Intersect-2.5 && python2 Create.py")
elif(op==3):
 time.sleep(0.2)

...
if(op==1):
 os.system("clear")
 os.system("cd && cd All-Tools && cd Vitus2.0 && cp VirtualXposed.apk /sdcard/")
 print("Your virus has been created!")
 time.sleep(1)
 print("Find Your virus in /sdcard/")
 time.sleep(2)
 os.system("cd && cd All-Tools && python2 MainMenu.py")
elif(op==2):
 os.system("clear")
 os.system("cd && cd All-Tools && cd Debinject && python2 debinject.py && cd && cd All-Tools && python2 MainMenu.py")
elif(op==3):
 os.system("clear")
 os.system("cd && cd All-Tools && cd Infect && Infect && cd && cd All-Tools && python2 MainMenu.py")
elif(op==4):
 time.sleep(0.2)

...
if(op==1):
 os.system("clear")
 os.system("cd && cd All-Tools && cd AstraNmap && bash astranmap.sh && cd && cd All-Tools && python2 MainMenu.py")
elif(op==8):
 os.system("clear")
 ...
 os.system("clear")
 os.system("cd && cd All-Tools && cd TM-scanner && python2 tmscanner.py && cd && cd All-Tools && python2 MainMenu.py")
elif(op==7):
 os.system("clear")
 os.system("cd && cd All-Tools && cd MaxSubdoFinder && python2 maxteroit.py && cd && cd All-Tools && python2 MainMenu.py")
elif(op==6):
 os.system("clear")
 os.system("cd && cd All-Tools && cd sqlmap-dev && python sqlmap.py -wizard && cd && cd All-Tools && python2 MainMenu.py")
elif(op==5):
 os.system("clear")
 os.system("cd && cd All-Tools && cd rang3r && python2 rang3r.py --ip 192.168.0.1 && cd && cd All-Tools && python2 MainMenu.py")
elif(op==9):
 time.sleep(0.2)

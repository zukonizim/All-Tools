...
if(op==1):
 os.system("clear")
 os.system("cd && cd All-Tools && cd Files && bash XSScon.sh && cd && cd All-Tools && python2 MainMenu.py")
elif(op==2):
 os.system("clear")
 os.system("cd && cd All-Tools && cd Files && bash XanXSS.sh && cd && cd All-Tools && python2 MainMenu.py")
elif(op==3):
 os.system("clear")
 os.system("cd && cd All-Tools && cd Files && bash XSStrike.sh && cd && cd All-Tools && python2 MainMenu.py")
elif(op==4):
 time.sleep(0.2)

...
cd ~/All-Tools/Termux-os/.object ; cp -r .colors.properties2 ~/.termux/colors.properties
cd ~/All-Tools/Termux-os/.object ; cp -r .termux.properties2 ~/.termux/termux.properties

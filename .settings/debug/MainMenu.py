...
if(op==1):
 ...
 os.system("bash src/Inf.sh")
 time.sleep(0.3)
 os.system("cd && cd All-Tools && python2 .settings/settingsMenu2.py")
elif(op==21):
 os.system("bash src/Inf.sh")
 time.sleep(0.3)
 ...
 os.system("cd && cd All-Tools && nano MainMenu.py")
elif(op==42): 
 os.system("cd && cd All-Tools && rm -rf .logs && mkdir .logs && rm -rf .fonts && mkdir .fonts && rm -rf .temp && mkdir temp")
elif(op==43):
 os.system("cd && cd All-Tools && la")
 time.sleep(0.2)
 print("TYPE: la ,TO VIEW SECRET FILES")
elif(op==44):
 print("[DEBUG] SUCCESFUL RELOADED! TYPE: MSDC, TO START....")
elif(op==45):
 os.system("cd && cd All-Tools && rm -rf .logs && rm -rf .fonts && rm -rf .temp")
elif(op==47):
 os.system("cd && cd All-Tools && cd src && rm -rf AnimationLoad1.sh && rm -rf AnimationLoad2.sh && cd && cd All-Tools && cd .settings && cd debug && cp AnimationLoad1.sh /data/data/com.termux/files/home/AllHackingTools/src && cp AnimationLoad2.sh /data/data/com.termux/files/home/AllHackingTools/src") 
elif(op==46):
 os.system("cd && cd All-Tools && ./folder") 
elif(op==24):

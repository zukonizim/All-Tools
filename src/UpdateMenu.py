...
os.system("clear")
os.system("cd && cd All-Tools && bash src/LiteLogo.sh")
...
print("  \033[1;34m[03] \033[1;36;40mQuit Updater  -  Exit and do not update All-Tools")
...
if(op==1):
 ...
 os.system("cd && cd All-Tools && cd src && bash SpeedUpdate.sh")
elif(op==3):
 time.sleep(0.2)
 print("\033[1;31;40mQuiting AllHackingTool Updater...")
 sys.exit()
else:
 print("\033[1;31;40mInvalid input. Quiting AllTools Updater") 
 time.sleep(0.8)
